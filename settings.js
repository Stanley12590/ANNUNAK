...
const settings = {
  ...
  packname: process.env.PACKNAME || 'STANYTZ',
  author: process.env.AUTHOR || 'STANYTZ',
  timeZone: process.env.TIMEZONE || 'Africa/Nairob',
  ...
  version: "5.2.0",
  updateZipUrl: process.env.UPDATE_URL || "https://github.com/Stanley12590/ANNUNAK/archive/refs/heads/main.zip",
  channelLink: process.env.CHANNEL_LINK || "https://whatsapp.com/channel/0029Vb7fzu4EwEjmsD4Tzs1p",
  ytch: process.env.YT_CHANNEL || "STANYTZ"
};
